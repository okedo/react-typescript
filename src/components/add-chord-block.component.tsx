...
export class AddChordBlockComponent extends React.Component<IAddChordProps, IAddChordState> {
                    ...
                    {this.state.collapsedList
                        ...
                        : (<div className={this.listStyle}>
                            {this.props.basicChords.map((el: IChordPropsModel) => {
                                return (
                                    <div className={this.listElementStyle} onClick={() => this.handleClick(el)} key={el.id}>
                                        {el.name}
                                    </div>
                                )
                            })}
